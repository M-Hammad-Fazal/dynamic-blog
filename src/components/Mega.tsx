...
export default function Mega() {
  ...
  const posts = [
...

    {
      ...
      description: 'Quantum computing promises to solve problems beyond the reach of classical computers. Explain the basics of quantum computing and its potential impacts.',
      date: '2024-12-31',
