...
//     ({ className, variant = "default", size = "dafault", asChild = false, ...props}, ref) => {
//         const Comp = "button";
//         return(
...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring:ring disabled:pointer-events-none disabled:opacity-50",
  {
    ...
    defaultVariants: {
      variant: "default",  // Corrected from "dafault" to "default"
      size: "default",
    },
  }
);
...
// ForwardRef component for Button with props passed down to the button element
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    const Comp = "button"; // You can change this dynamically if needed
    return (
      <Comp
